...
<nav x-data="{ open: false }" class="sticky top-0 z-50 bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('work-schedule.edit')" :active="request()->routeIs('work-schedule.*')" wire:navigate>
                        {{ __('Jam Kerja') }}
                    </x-nav-link>
                    <x-nav-link :href="route('reports.attendance')" :active="request()->routeIs('reports.*')" wire:navigate>
                        {{ __('Laporan') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('work-schedule.edit')" :active="request()->routeIs('work-schedule.*')" wire:navigate>
                {{ __('Jam Kerja') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('reports.attendance')" :active="request()->routeIs('reports.*')" wire:navigate>
                {{ __('Laporan') }}
            </x-responsive-nav-link>
